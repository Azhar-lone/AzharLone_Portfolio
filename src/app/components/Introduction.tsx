...
const Introduction: React.FC = () => {
  return (
    <div className="  transition-all flex flex-col  lg:items-start items-center gap-2 p-4 rounded-lg w-[100%]  mx-auto lg:mx-0  lg:w-[30%] lg:left-0 lg:fixed lg:top-[10vh] h-full  lg:bg-secondary lg-h-[90vh]">
