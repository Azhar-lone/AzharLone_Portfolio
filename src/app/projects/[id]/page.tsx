    ...
    <>
      <main className="mx-8">
        ...
        >
          ...
          <h1
            className={` select-none -z-10 text-[max(30vw,132px)] leading-none font-extrabold italic tracking-tighter bg-gradient-to-t from-main/30 to-main bg-clip-text text-transparent`}
          >
            Vibe
          </h1>
          <Link
        ...
        >
          <h2
            className={`md:text-4xl text-3xl text-center tracking-tighter font-bold my-8`}
          >
            Features
          </h2>
          <ul className="grid grid-cols-1 grid-rows-6 md:grid-cols-3 md:grid-rows-2 gap-8 max-w-7xl mx-auto">
            <li className="flex flex-col gap-2.5 p-6 border text-center rounded-md shadow-md">
              ...
              <h3 className={`md:text-3xl text-2xl text-main font-bold`}>
