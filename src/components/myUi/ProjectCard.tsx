...
const ProjectCard: React.FC<propsType> = ({ project }) => {
  ...
  return (
    ...
    <div
      className="h-96 mt-5 border rounded-2xl  shadow-2xl  shadow-primary  md:w-[48%] group relative"
    >
      ...
      <div className="   p-6 ">
        ...
        <ScrollArea className=" overflow-y-auto h-10 text-light">{project.description}</ScrollArea>
      </div>
